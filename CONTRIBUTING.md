...
Please note that baRulho is released with a [Contributor Code of
...
available [Documentation](https://docs.ropensci.org/baRulho//articles/).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/ropensci/baRulho/issues/) that might help
...
- Open an
  [https://github.com/ropensci/baRulho/issues/](https://github.com/ropensci/baRulho/issues/new).
...
- Determine if your bug is really a bug and not an error on your side
  ...
  [documentation](https://docs.ropensci.org/baRulho//articles/). If you
...
- Open an [Issue](https://github.com/ropensci/baRulho/issues/new).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://docs.ropensci.org/baRulho//articles/)
  carefully and find out if the functionality is already covered, maybe
  by an individual configuration.
- Perform a [search](https://github.com/ropensci/baRulho/issues/) to see
...
issues](https://github.com/ropensci/baRulho/issues/).
